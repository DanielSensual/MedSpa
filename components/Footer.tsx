...
export default function Footer() {
    return (
        <footer className="relative border-t border-white/[0.06] bg-[#0a0a0f] py-16">
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    {/* Brand */}
                    <div className="lg:col-span-2">
                        <a href="/" className="flex items-center gap-3 group">
                            <span className="h-8 w-8 rounded-full bg-gradient-to-br from-[#c4a47c] to-[#e8c4c4] shadow-[0_0_20px_rgba(196,164,124,0.3)]" />
                        ...
                        <div className="mt-6 flex gap-4">
                            <a
                                ...
                                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-zinc-400 transition-all hover:border-[#c4a47c]/50 hover:text-[#c4a47c]"
                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-3 text-zinc-400">
                            <a href={`tel:${siteConfig.phone.replace(/[^0-9]/g, '')}`} className="block hover:text-white transition-colors">
                                {siteConfig.phone}
                            </a>
